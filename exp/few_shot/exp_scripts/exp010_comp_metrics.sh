single_metrics="['disagree_flag','overall','factual-accuracy'] ['writing-style','completeness','relevance']"

base_run_id=exp-comp-metric
folder_path=exp/few_shot/runs/exp-comp-metric
mkdir $folder_path
